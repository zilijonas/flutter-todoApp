...
class ReorderableListSimple extends StatefulWidget {
  ...
  State<ReorderableListSimple> createState() =>
      new _ReorderableListSimpleState(onItemRemoved);
}

class _ReorderableListSimpleState extends State<ReorderableListSimple> {
  _ReorderableListSimpleState(this.onItemRemoved);
  ...
  Widget _buildInnerItem(BuildContext context) {
    ...
    children.add(ReorderableListener(
      child: Container(
          ...
          child: Padding(
              child: Opacity(opacity: 0.6, child: icon),
    ...
    final Dismissible dismissibleRow = Dismissible(
      key: key,
      ...
      onDismissed: (DismissDirection dir) {
        onRemove(itemIndex);
        // Scaffold.of(context).showSnackBar(SnackBar(conte));
      ...
      secondaryBackground: Container(
        child: Icon(Icons.mode_edit, color: Colors.green, size: 32),
